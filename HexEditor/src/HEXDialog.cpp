...
void HexEdit::Delete(void)
{
	...
	{
		count = abs((int)(_pCurProp->anchorPos  - _pCurProp->cursorPos)); // C2668 without int cast
		lines = abs((int)(_pCurProp->anchorItem - _pCurProp->cursorItem)); // C2668 without int cast
	}
	else
	{
